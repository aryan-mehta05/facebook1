              ...
              <TabsContent value="signup">
                <form onSubmit={handleSubmitSignUp(onSubmitRegister)}>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="signupBirthday">Date Of Birth</Label>
                      <Input
                        id="signupBirthday"
                        name="dateOfBirth"
                        type="date"
                    ...
                    <div className="space-y-2">
                      ...
                      <Controller
                        control={control}
                        name="gender"
                        defaultValue="male" // Set the default value
                        render={({ field }) => (
                          <RadioGroup
                            className="flex justify-between"
                            value={field.value}
                            onValueChange={field.onChange} // Spread the field props (value, onChange, etc.)
                          >
