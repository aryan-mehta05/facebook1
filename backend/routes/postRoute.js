...
const { createPost, getAllPosts, getPostByUserId, deletePost, likePost, sharePost, addCommentToPost, getAllStory, createStory } = require('../controllers/postController');
